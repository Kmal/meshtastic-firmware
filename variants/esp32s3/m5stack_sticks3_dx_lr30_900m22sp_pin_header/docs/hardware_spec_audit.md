...
| 3V3_L2 firmware enable | Set M5PM1 `PWR_CFG` bit 2 (`LDO_EN`) during early init | StickS3 schematic names `3V3_L2_EN`; M5PM1 register docs define `PWR_CFG` bit 2 as 3.3 V LDO enable. |
...
- DX VCC measured at 3.3 V on StickS3 `3V3_L2` with common GND after early init sets M5PM1 `LDO_EN`.
